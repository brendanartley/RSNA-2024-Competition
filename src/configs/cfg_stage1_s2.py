...
cfg.img_dir= "./data/processed_stage1/"
cfg.project= "rsna_localizer"
...
# RSNA specific
cfg.plane= "s2" # "s1", "s2", "a2"
cfg.condition= "all" # "foraminal", "subarticular", "spinal", "all"
...
# Model
cfg.model_type = "cnn25d_keypoint"
cfg.backbone= "hgnetv2_b5.ssld_stage2_ft_in1k"
cfg.drop_path_rate= 0.2
cfg.fc_dropout= 0.05
cfg.in_chans= 1
cfg.attn_type= "Attention"
cfg.n_frames= 8
